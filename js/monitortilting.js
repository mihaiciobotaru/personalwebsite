			...
			function init() { 
				...
				{					
					ratio = (window.innerWidth) / (window.innerHeight/1.5);
				}else {
					ratio = (window.innerWidth/1.8) / (window.innerHeight/1.8);
				}
			...
			function onWindowResize() {
				...
				{					
					...
					camera.aspect = (window.innerWidth/1.8) / (window.innerHeight/1.8);
					renderer.setSize( (window.innerWidth/1.8), (window.innerHeight/1.8) );
				}
